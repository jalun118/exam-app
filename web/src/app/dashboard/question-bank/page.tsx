...
import SubmenuQuestionBank from "./sub-menu/client-submenu-question-bank";

export default function PageQuestionBank() {
  return (
    <div>
      ...
      <div className="mb-5 flex flex-col-reverse gap-y-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex">
          <Link
            href={PrefixDashboard("/question-bank/create-question")}
