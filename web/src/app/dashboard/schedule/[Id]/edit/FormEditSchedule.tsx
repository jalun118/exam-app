...
const dummyData = {
  schedule_name: "Ulangan Harian",
  date_start: "2024-01-20T13:00:00.000Z",
  date_end: "2024-01-20T13:00:00.000Z",
  anti_cheat: true,
  randomize: false,
  room: ListRoom[2],
  giving_question: "",
  extend_question_id: "9da948f5-79ba-4bc5-92f0-ef816dd08d2d",
  duration_schedule: 20,
};

export default function FormEditSchedule() {
  const [getOpen, SetOpen] = useState(false);
  const [selected, setSelected] = useState(dummyData.room);
    ...
    <div>
      <div className="max-w-lg">
        ...
        <input
          ...
          spellCheck={false}
          defaultValue={dummyData.schedule_name}
          id="title-schedule"
      ...
      <div className="mt-4 max-w-lg">
        ...
        <div className="relative">
          <input
            ...
            autoComplete="off"
            autoCorrect="off"
            defaultValue={dummyData.extend_question_id}
            aria-autocomplete="none"
            spellCheck={false}
            id="id-package"
        ...
        <div className="flex flex-col gap-y-4">
          <label className="inline-flex items-center md:cursor-pointer">
            <input
              ...
              defaultChecked={dummyData.randomize}
            />
          ...
          <label className="inline-flex items-center md:cursor-pointer">
            <input
              type="checkbox"
              className="peer sr-only"
              defaultChecked={dummyData.anti_cheat}
            />
            <div className="relative h-6 w-11 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-0.5 after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white dark:border-gray-600 dark:bg-gray-700 rtl:peer-checked:after:-translate-x-full"></div>
            <span className="ms-3 text-gray-900 dark:text-gray-300">
              Anti Cheat
      ...
      <div className="mt-4 max-w-lg">
        ...
        <input
          ...
          autoCorrect="off"
          aria-autocomplete="none"
          defaultValue={dummyData.giving_question}
          spellCheck={false}
      ...
      <div className="mt-4 max-w-lg">
        ...
        <input
          ...
          aria-autocomplete="none"
          spellCheck={false}
          defaultValue={dummyData.date_start.split(".")[0]}
          id="start-schedule"
          className="block w-full rounded-lg border-gray-400 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
        />
      </div>
      ...
      <div className="mt-4 max-w-lg">
        ...
        <input
          ...
          aria-autocomplete="none"
          spellCheck={false}
          defaultValue={dummyData.date_end.split(".")[0]}
          id="max-schedule"
          className="block w-full rounded-lg border-gray-400 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
        />
      </div>
      ...
      <div className="mt-4 max-w-lg">
        ...
        <input
          ...
          aria-autocomplete="none"
          spellCheck={false}
          defaultValue={dummyData.duration_schedule}
          id="duration-exam"
          className="block w-full rounded-lg border-gray-400 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
          placeholder="30"
        />
